...
// Folded-paper star palette — 治愈手账风：淡粉、鹅黄、薄荷绿、浅蓝
const STAR_COLORS = [
  { fill: '#ffd3dd', shade: '#f0a8b8', name: 'cherry' },    // 淡粉
  { fill: '#ffe9a8', shade: '#f0c870', name: 'butter' },    // 鹅黄
  { fill: '#fff2c8', shade: '#e8d590', name: 'cream' },     // 奶黄
  { fill: '#bfe6c8', shade: '#85c498', name: 'mint' },      // 薄荷绿
  { fill: '#c8e4ec', shade: '#90c0d0', name: 'sky' },       // 浅蓝
  { fill: '#d8d5ee', shade: '#a8a3d0', name: 'lilac' },     // 浅紫
  { fill: '#ffd6c2', shade: '#f0a888', name: 'peach' },     // 浅桃
  { fill: '#e5e7c8', shade: '#b8be90', name: 'sage' },      // 浅黄绿
];
...
function drawStar(c, s, now) {
  ...
  // ---- Sealed: dashed wax-ring around envelope ----
  if (s.sealed) {
    c.restore(); // close alpha
    ...
    c.strokeStyle = 'rgba(217, 122, 142, 0.65)'; // pink-d dashed
    c.lineWidth = 1.2;
    c.beginPath();
